"""Follow-up-only safety witnesses retained from candidate 0d790e7.

Covers migration atomicity, strict rejection, dispatch uncertainty, late receipts
and known-not-called retries; excludes the candidate's unrelated public queue.
No external network or live state.
"""
