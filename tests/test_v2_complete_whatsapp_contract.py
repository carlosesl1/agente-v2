...
def _base(tmp_path: Path) -> dict[str, str]:
    return {
        ...
        "V2_MANYCHAT_REPLY_FLOW_NS": "flow:reply:v2",
        "V2_MANYCHAT_PAYMENT_LINK_FIELD_ID": "201",
        "V2_MANYCHAT_PAYMENT_DESCRIPTION_FIELD_ID": "202",
        "V2_MANYCHAT_PAYMENT_FLOW_NS": "flow:payment:v2",
        "V2_MANYCHAT_HANDOFF_TAG_ID": "301",
        "V2_MANYCHAT_HANDOFF_FLOW_NS": "flow:handoff:v2",
